...
BOT_TOKEN = environ.get('BOT_TOKEN', '7904662527:AAFONbz-rj3I9l1nZbSm_iWPJgdqn75vC5k')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1454524346').split()]
USERNAME = environ.get('USERNAME', "https://t.me/er_prajwalpatil") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002349927875'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+E4juWuI11Tw5MzI1')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002298548711').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://PrajwalXP:PrajwalXP@prajwalxp.rnfmz.mongodb.net/?retryWrites=true&w=majority&appName=PrajwalXP")
DATABASE_NAME = environ.get('DATABASE_NAME', "XPUniverseBoT 02")
